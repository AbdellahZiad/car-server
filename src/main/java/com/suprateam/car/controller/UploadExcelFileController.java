...
public class UploadExcelFileController {
    ...
    @PostMapping("/upload")
    ResponseEntity<?> uploadFileExcel(@RequestParam("file") MultipartFile reapExcelDataFile) throws Exception {
        return ResponseEntity.ok(uploadFileExcel.uploadFileExcel(reapExcelDataFile));
    }
